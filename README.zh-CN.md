...
AgentBridge 的 AI 功能需要 LLM API Key。默认使用 Anthropic Claude，但你可以配置任何兼容 Anthropic 协议的提供商：
...
<details>
<summary>🔧 `pip install agentbridge` 是如何工作的？</summary>
...
发布后，任何人都可以运行 `pip install agentbridge`。
